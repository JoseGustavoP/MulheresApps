...
<?php include("design1.php");
   ...
   $consulta4 = $MySQLi->query("SELECT mul_foto, mul_nome, mul_codigo, ate_data FROM tb_atendimentos 
                            JOIN tb_mulheres ON mul_codigo = ate_mul_codigo
          ...
          <div class="card-body">
            ...
            <p><b>Insira o CPF da mulher para iniciar um novo atendimento</b></p>
                <div class="input-group mb-3">
                  <input name="cpf" id="cpf" type="text" class="form-control rounded-0" data-inputmask="'mask': ['999.999.999-99']" data-mask>
          ...
          <div class="card-body">
            ...
            <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                        <td class="align-middle"><img class="img-circle elevation-2" alt="" width="40" src="<?php echo 'imagens/mulheres/' . $resultado4['mul_foto'] . '.jpg' ?>"></td>
            			<td class="align-middle"><?php echo $resultado4['mul_nome']?></td>
            			<td class="align-middle"><?php if(date('Y-m-d')==date("Y-m-d", strtotime($resultado4['ate_data']))) echo date("H:i", strtotime($resultado4['ate_data'])); else echo date("d/m", strtotime($resultado4['ate_data']))?></td>
                        <td class="align-middle"><a href="mulher-ver.php?codigo=<?php echo $resultado4['mul_codigo']; ?>" class="btn btn-sm btn-primary btn-xs"><i class="fas fa-folder-open"></i> Ver</a></td>
                          </td>
                    </tr>
                    <?php } ?>
          ...
          <div class="card-body">
            ...
            <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                        <td class="align-middle"><img class="img-circle elevation-2" alt="" width="40" src="<?php echo 'imagens/mulheres/' . $resultado3['mul_foto'] . '.jpg' ?>"></td>
            			<td class="align-middle"><?php echo $resultado3['mul_nome']?></td>
            			<td class="align-middle"><?php if(date('Y-m-d')==date("Y-m-d", strtotime($resultado3['ate_data']))) echo date("H:i", strtotime($resultado3['ate_data'])); else echo date("d/m", strtotime($resultado3['ate_data']))?></td>
                        <td class="align-middle"><a href="mulher-ver.php?codigo=<?php echo $resultado3['mul_codigo']; ?>" class="btn btn-sm btn-primary btn-xs"><i class="fas fa-folder-open"></i> Ver</a></td>
                    </tr>
                    <?php } ?>
