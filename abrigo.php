...
<section class="content">
  <div class="container-fluid">
    ...
    <div class="card card-primary card-outline">
      ...
      <div class="card-body">
        <?php
        // Verifica se o parâmetro 'antigos' foi passado na URL e define a variável
        $antigos = isset($_GET['antigos']) ? $_GET['antigos'] : 0;
        ?>
        ...
        <div class="form-group">
          <div class="custom-control custom-switch">
            <input <?php if ($antigos == 1)
              ...
              id="customSwitch1"
              onclick="this.checked == true ? window.location.href = '?antigos=1' : window.location.href = '?'">
                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    <?php while ($resultado = $consulta->fetch_assoc()) { ?>
                      <tr>
                        <td><img class="img-circle elevation-2" width="30"
                            src="<?php echo 'imagens/mulheres/' . $resultado['mul_foto'] . '.jpg' ?>"></a></td>
                        ...
                        <td>
                          <?php if ($resultado['abr_data_fim'] != '')
                            echo hora($resultado['abr_data_fim']);
                          else
                            echo '-' ?>
                          </td>
