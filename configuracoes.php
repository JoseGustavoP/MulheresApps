            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="email" name="email" class="form-control" value="<?php echo $resultado['tec_email'] ?>"
              ...
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input name="telefone" type="text" class="form-control"
                    data-inputmask="'mask': ['(99) 9999-9999','(99) 9 9999-9999']" data-mask
                    value="<?php echo $resultado['tec_telefone'] ?>" placeholder="Seu telefone (para a equipe)">
                </div>
                <!-- /.input group -->
              </div>
              ...
              <div class="row">
                <div class="col-md-3">
                  ...
                  <img src="<?php echo 'imagens/tecnicos/' . $_SESSION['id'] . '.jpg?' . time() ?>"
                    class="img-circle elevation-2" alt="Foto" width="100%" style="max-heigh: 100px">
          ...
          <form role="form" method="POST" action="?">
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input name="senhaatual" required type="password" class="form-control" id="exampleInputEmail2"
                  placeholder="">
              </div>
              ...
              <div class="form-group">
                ...
                <input minlength="8" required name="novasenha" type="password" class="form-control" id="senha"
                  placeholder="">
              </div>
              <div class="form-group">
