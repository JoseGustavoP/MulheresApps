...
<head>
  ...
  <meta name="google-signin-client_id"
    content="582244156383-8h7u6g4vh6sahpml3sb6i3f3hbvj4l57.apps.googleusercontent.com">
</head>
...
<body class="hold-transition sidebar-mini">
  <div class="wrapper">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="mensagens.php">
            ...
            <?php if ($nolidas['nolidas'] > 0) { ?><span
                class="badge badge-danger navbar-badge"><?php echo $nolidas['nolidas'] ?><?php } ?></span>
          </a>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      <!-- Brand Logo -->
      <a onClick="window.location='index.php'" class="brand-link">
        <img src="imagens/logomc.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
          style="opacity: .8">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            <img onClick="window.location='configuracoes.php'"
              src="<?php echo 'imagens/tecnicos/' . $_SESSION['id'] . '.jpg?' . time() ?>"
              class="img-circle elevation-2" alt="User Image">
          </div>
          <div class="info">
            <a onClick="window.location='configuracoes.php'" class="d-block"><?php echo $_SESSION['nome'] ?></a>
          </div>
        </div>
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="index.php" class="nav-link <?php if ($design_ativo == 'm1')
                echo "active"; ?>">
            ...
            <li class="nav-item">
              <a href="mulheres.php" class="nav-link <?php if ($design_ativo == 'm2')
                echo "active"; ?>">
            ...
            <li class="nav-item">
              <a href="atendimentos.php" class="nav-link <?php if ($design_ativo == 'm3')
                echo "active"; ?>">
            ...
            <li class="nav-item">
              <a href="tecnicos.php" class="nav-link <?php if ($design_ativo == 'm4')
                echo "active"; ?>">
            ...
            <?php if ($_SESSION['admin'] == 1) { ?>
              <li class="nav-item">
                <a href="tecnicos_adm.php" class="nav-link <?php if ($design_ativo == 'm4b')
                  echo "active"; ?>">
                  <i class="nav-icon fas fa-users"></i>
                  <p>Técnicos (ADM)</p>
                </a>
            ...
            <?php } ?>
            <li class="nav-item">
              <a href="relatorios.php" class="nav-link <?php if ($design_ativo == 'm10')
                echo "active"; ?>">
            ...
            <!--      </li>-->
            <li class="nav-item">
              <a href="abrigo.php" class="nav-link <?php if ($design_ativo == 'm7')
                echo "active"; ?>">
            ...
            <li class="nav-item">
              <a href="campos_ do_formulario.php" class="nav-link <?php if ($design_ativo == 'm12')
                echo "active"; ?>">
                <i class="nav-icon fas fa-cogs"></i>
                <p>Campos de Formulários</p>
              </a>
            <li class="nav-item">
              <a href="suporte.php" class="nav-link <?php if ($design_ativo == 'm11')
                echo "active"; ?>">
              ...
              <ol class="breadcrumb float-sm-right">
                ...
                <?php } elseif ($design_migalha1_texto != "" && $design_migalha1_texto != "") { ?>
                  ...
                  <li class="breadcrumb-item"><a
                      href="<?php echo $design_migalha1_link; ?>"><?php echo $design_migalha1_texto; ?></a></li>
