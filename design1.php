  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img onClick="window.location='configuracoes.php'" src="<?php echo 'imagens/tecnicos/'  . $_SESSION['id'] . '.jpg?' . time() ?>" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="index.php" class="nav-link <?php if($design_ativo=='m1') echo "active"; ?>">
          ...
          <?php } ?>
          <li class="nav-item">
            <a href="relatorios.php" class="nav-link <?php if($design_ativo=='m10') echo "active"; ?>">
    ...
    <!--      </li>-->
		  ...
		  <li class="nav-item">
            <a href="suporte.php" class="nav-link <?php if($design_ativo=='m11') echo "active"; ?>">
